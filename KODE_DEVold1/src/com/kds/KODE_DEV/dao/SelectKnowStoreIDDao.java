...
public class SelectKnowStoreIDDao {
	Connection connection = null;
	PreparedStatement preparedStatement = null;
	
	OwnerSetUpKnowStoreDomain rDomain = new OwnerSetUpKnowStoreDomain();

	public String fetchKnowStoreID(OwnerSetUpKnowStoreDomain rDomain) {
		String kID="";
		try {
	...
	public String fetchEmailId(OwnerSetUpKnowStoreDomain rDomain) {
		String emailId="";
		...
		try {
			...
			//PreparedStatement preparedStatement = null;
			ResultSet resultSet = null;
			String sql = "select email from users_info where "
					//+ "user_id = '"
					//+ rDomain.getUserId() + "' and
					+ "organization_id= '"
					+ rDomain.getOrgId() + "'";
			preparedStatement = connection.prepareStatement(sql);
