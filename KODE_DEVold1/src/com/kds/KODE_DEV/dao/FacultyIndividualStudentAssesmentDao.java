...
public class FacultyIndividualStudentAssesmentDao {
	Connection con = null;
		   ...
		   public ArrayList<RetriveImagesDomain> selectCourses(DisplayCoursesDomain ri){
			...
			//	DBTransaction1 dbt1 = new DBTransaction1();
				...
				try {
					...
					//PreparedStatement pstmt = null;
					ResultSet rs = null;			
					String quary = "SELECT assessment_name,uploaded_by FROM assessment_info where organization_id='"+ri.getCourseFee()+"' and uploaded_by='"+ri.getCourseDetails()+"' and (recipient_type like '%"+ri.getCourseName()+"%' or recipient_type='All')";
