...
public class ParticipantSubjectDescriptionDao {
	Connection con = null;
	 ...
	 public ArrayList<SubjectDescriptionDomain> subjectDescription(DisplayCoursesDomain dcd){
		  // DBTransaction1 dbt = new DBTransaction1();
			...
			try {
				...
				//PreparedStatement pstmt = null;
				ResultSet rs = null;
				String quary = "select * from subject_details where subject_name='"+dcd.getCourseName()+"' and organization_id='"+dcd.getCourseDetails()+"'";
