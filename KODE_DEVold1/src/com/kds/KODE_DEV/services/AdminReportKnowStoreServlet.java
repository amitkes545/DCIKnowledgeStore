...
public class AdminReportKnowStoreServlet extends CommonService {
	
	static final Logger LOGGER = Logger.getLogger(AdminReportKnowStoreServlet.class);
	...
	public void run() throws ServletException, IOException {
		...
		response.sendRedirect("../JSP/AdminShowReportKnowStore.jsp");
