...
//import com.kds.keducom.ftpconnection.FtpTransaction;


import com.kds.KODE_DEV.dbconnection.DBTransaction;

@SuppressWarnings("serial")
public class FacilitatorGetSessionBackupServlet extends CommonService {
	
	static final Logger LOGGER = Logger.getLogger(FacilitatorGetSessionBackupServlet.class);
	...
	public void run() throws Exception
	{
     ...
     String fileName="sessionDetails.csv";
		//String UPLOAD_DIRECTORY = "";
		//String dirname="";
        ...
        ResultSet res = st.executeQuery("select * from session_details");
  		      ...
  		      /*JFileChooser chooser = new JFileChooser();
     			...
     			if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
     				...
     				dirname = chooser.getSelectedFile() + "/Downloads/";
      				...
      				dir.mkdirs();*/
  		      fw = new FileWriter(uploadPath+"/sessionDetails.csv");
                   ...
                   fw.flush();
                    ...
                    String uploadPathName=uploadPath+"/"+fileName;
		 			...
		 			FileInputStream inStream = new FileInputStream(uploadPathName);
			          ...
			          out.close();  
			          String dataStatus="Data is stored in sessionDetails File";
             ...
             // }
     			/*else if(i==1)
    			{
    				...
    				RequestDispatcher rd = request
    						.getRequestDispatcher("../JSP/FacilitatorGetSessionBackup.jsp");
    				rd.forward(request, response);
       ...
       // pw.println("data is stored in home folder sample file");
        /*if(winname.equalsIgnoreCase("Windows")){
	        	UPLOAD_DIRECTORY=download_path;
	        	 uploadPath =  "/"+ download_path;
	        	 LOGGER.info("upload path:"+uploadPath);
	        	 String dataStatus="Data is Stored in"+ uploadPath+"sessionDetails File";
	     		request.setAttribute("FacultySuccess",dataStatus);
	     		RequestDispatcher rd=request.getRequestDispatcher("../JSP/Home.jsp");
	     		rd.forward(request, response);
	        }else{
