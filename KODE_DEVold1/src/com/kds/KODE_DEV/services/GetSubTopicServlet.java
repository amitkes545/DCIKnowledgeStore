...
public class GetSubTopicServlet  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			while (rs.next()) {
				...
				subTopic.setSubTopicId(rs.getString(1));
				subTopic.setSubTopic(rs.getString(2));
				subTopic.setTopicId(rs.getString(3));
