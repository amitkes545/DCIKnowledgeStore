...
public class UsersFacilitatorReportsServlet extends CommonService{
	public void run() throws ServletException,IOException{
		...
		if(sorgid!=null){
			//System.out.println("organization in service if:"+sorgid);
			ArrayList<String> resultuserid=urdao.getAdminUserId(sorgid,sessionUserid);
			String[] resulArr = new String[resultuserid.size()];
			 ...
			 response.sendRedirect("../JSP/UserFacilitatorReports.jsp");
        ...
        if("userid is wrong".equalsIgnoreCase(result))
        {
        	...
        	String msg = "UserId is wrong!please try again";
   		  ...
   		  RequestDispatcher rd=request.getRequestDispatcher("../JSP/UserFacilitatorReports.jsp");
		...
		//System.out.println("create domain value is:"+udao.getAddress());
		 ...
		 response.sendRedirect("../JSP/UserFacilitatorReportsDetails.jsp");
        }
	}
	}   
