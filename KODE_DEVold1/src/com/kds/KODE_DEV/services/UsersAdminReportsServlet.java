...
public class UsersAdminReportsServlet extends CommonService {
	public void run() throws ServletException,IOException{
		...
		if(sorgid!=null){
			...
			ArrayList<String> resultuserid=urdao.getSuperAdminUserId(sorgid,sessionuserid);
			String[] resulArr = new String[resultuserid.size()];
			 ...
			 response.sendRedirect("../JSP/UserAdminReports.jsp");
        ...
        if("userid is wrong".equalsIgnoreCase(result))
        {
        	...
        	String msg = "UserId is wrong!please try again";
   		  ...
   		  RequestDispatcher rd=request.getRequestDispatcher("../JSP/UserAdminReports.jsp");
		...
		//System.out.println("create domain value is:"+udao.getAddress());
		 ...
		 response.sendRedirect("../JSP/UsersAdminReportsDetails.jsp");
        }
	}
	}   
