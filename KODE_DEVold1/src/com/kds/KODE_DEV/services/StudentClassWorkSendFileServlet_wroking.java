...
public class StudentClassWorkSendFileServlet_wroking extends CommonService {
	...
	public void run() throws ServletException, IOException {
		...
		//if (isMultiPart){
			...
			/*
			 * String orgid =(String)session.getAttribute("orgid"); String
			 * userID =(String)session.getAttribute("userid");
			 * 
			 * /*FacilitatorSelectKnowStoreIdDao ksidDao = new
			 * FacilitatorSelectKnowStoreIdDao();
			 * 
			 * String KsID1 = ksidDao.fetchDynamicKsid(userID);
			 * 
			 * LOGGER.info("Hey its mine"+ KsID1);
			 */
...
String password =PropertiesUtil.getProperty("password1");	
			...
			ksfDomain.setUploadedBy("student@srm");
			...
			RequestDispatcher requestDispatcher = request
					.getRequestDispatcher("../JSP/KSStudentView.jsp");
