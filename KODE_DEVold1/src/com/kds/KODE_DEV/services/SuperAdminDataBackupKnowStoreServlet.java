...
public class SuperAdminDataBackupKnowStoreServlet<users_info> extends CommonService { 
	

	static final Logger LOGGER = Logger.getLogger(SuperAdminDataBackupKnowStoreServlet.class);
	public void run() throws Exception
	{
      ...
      String fileName="SuperAdminsample.csv";
         ...
         LOGGER.info("the quary is:"+res);
             ...
             //download_path = System.getProperty("user.home") + "/Downloads";
               try {
  		      ...
  		      fw = new FileWriter(uploadPath+"/SuperAdminsample.csv");
                    ...
                    String uploadPathName=uploadPath+"/"+fileName;
		 			...
		 			FileInputStream inStream = new FileInputStream(uploadPathName);
			          ...
			          String dataStatus="Data is stored in sample file under Downloads folder";
			       		request.setAttribute("SuperAdminSuccess",dataStatus);
			       		RequestDispatcher rd=request.getRequestDispatcher("../JSP/SuperAdminDataBackupKnowStore.jsp");
             ...
             // }
       			/*else if(i==1)
    			{
    				...
    				RequestDispatcher rd = request
    						.getRequestDispatcher("../JSP/SuperAdminDataBackupKnowStore.jsp");
    				rd.forward(request, response);
