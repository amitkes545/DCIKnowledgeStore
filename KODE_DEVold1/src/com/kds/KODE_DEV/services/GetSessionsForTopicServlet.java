...
@WebServlet("/getSessionsForTopic")
public class GetSessionsForTopicServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String topicId=request.getParameter("selectedValue");
			System.out.println("Course Id : "+topicId);
