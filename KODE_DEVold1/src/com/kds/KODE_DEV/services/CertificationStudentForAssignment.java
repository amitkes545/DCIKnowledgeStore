...
public class CertificationStudentForAssignment extends CommonService {

	static final Logger LOGGER = Logger
			.getLogger(CertificationStudentForAssignment.class);
	...
	public void run() throws ServletException, IOException {
		...
		recipientTypeForAssignment = searchDao
				.getRecipientTypeForAssignmentMarks(assessmentDomain, orgId,
						facultyId);
		}
			...
			// assignment_info)
			recipientTypeForAssignment = searchDao
					.getAllRecipientTypeForAssignmentMarks(assessmentDomain, orgId,
							facultyId);
		}
