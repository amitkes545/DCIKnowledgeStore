	...
	public void run() throws ServletException,IOException{
		...
		System.out.println("selectstudent"+selectstudent);
		 if(!(request.getParameter("selectstudent").equalsIgnoreCase("All"))&& (!(request.getParameter("status").equalsIgnoreCase("All")))){
				...
				ArrayList<ActiveSessionDomain> sessionDetailsAll=createSessionDao.getStudentForIndividual(selectstudent,courseid,status,organizationId);
			...
			ArrayList<ActiveSessionDomain> sessionDetailsAll=createSessionDao.getStudentsForStatus(courseid,organizationId);
			request.setAttribute("sessionDetails", sessionDetailsAll);
			...
			ArrayList<ActiveSessionDomain> sessionDetailsAll=createSessionDao.getStuDetails(courseid,status,organizationId);
			request.setAttribute("sessionDetails", sessionDetailsAll);
