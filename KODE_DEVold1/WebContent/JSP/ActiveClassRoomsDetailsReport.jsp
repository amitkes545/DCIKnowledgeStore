...
function actionGetList(){
	...
	document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_UA_010&startDate="+startDate+"&endDate="+endDate+"&sessionId="+sessionId+"&ExpRepFormat=None";
...
var x = document.getElementById("tableColumn").rows.length;
	...
	if(x>1)
		if(exportval=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_UA_010&startDate="+startDate+"&endDate="+endDate+"&sessionId="+sessionId+"&ExpRepFormat="+exportval;
			document.ksStore.submit();
...
<body>
	...
	<div class="container">
		...
		<p class="strong">Details of Classrooms Strength</p>
		...
		<thead>
		 <tr class="row_head">
			...
			<th width="25%">Session ID <div class="header_stop" style="width:25%;">Session ID</div></th>
			<th width="25%">Session Name <div class="header_stop" style="width:25%;">Session Name</div></th>
			<th width="25%">No.Of Students	<div class="header_stop" style="width:25%;">No.Of Students</div></th>
		...
		<td width="25%" style="text-align:center;">
		<%=stuinfo.get("NoOfStudents").toString().trim()%>
		</td>
