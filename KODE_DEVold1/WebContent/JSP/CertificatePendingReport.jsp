...
function actionGetList(){
	...
	if(courseval=="")
		...
		document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AD_013&Course="+courseval+"&ExpRepFormat=None";
...
var x = document.getElementById("tableColumn").rows.length;
	...
	if(x>1)
		if(ExportVal=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AD_013&&Course="+courseval+"&ExpRepFormat="+ExportVal;
			document.ksStore.submit();		
	...
	<div class="container">
		...
		<div class="postpon_mod">
			<div style="text-align: center;">
				<p class="strong">Certificates Pending Students</p>
		...
		<thead>
		 <tr class="row_head">
			<th width="16.6%">Course ID<div class="header_stop" style="width:16.6%;">Course ID</div></th>
			<th width="16.6%">Course Name <div class="header_stop" style="width:16.6%;">Course Name </div></th>
			<th width="16.6%">Student ID<div class="header_stop" style="width:16.6%;">Student ID</div></th>
			<th width="16.6%">Student Name<div class="header_stop" style="width:16.6%;">Student Name</div></th>
			<th width="16.6%">Contact No<div class="header_stop" style="width:16.6%;">Contact No</div></th>
			<th width="16.6%">Email<div class="header_stop" style="width:16.6%;">Email</div></th>
		</tr>
		</thead>
		...
		<td width="16.6%" style="text-align:center;">
		<%=stuinfo.get("course_id_declared_by_teaching_source").toString().trim() %>
		</td>
		<td width="16.6%">
