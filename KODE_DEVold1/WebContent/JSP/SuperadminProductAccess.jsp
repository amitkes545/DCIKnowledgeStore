...
$(document).ready(function() {
   ...
   $("#addrowsave").click(function() {
	   ...
	   if(addname == ""){
	    	  ...
	    	  document.pName1.action="/KODE_DEV/ControllerServlet/SuperadminProductAccessServlet";
...
function deleteRow(id) {
	alert("are sure want delete this row");
		 document.pName1.action="/KODE_DEV/ControllerServlet/SuperadminProductAccessServlet?Delid="+id;
		 document.pName1.submit();
...
<div class="container">
	<jsp:include page="../JSP/all_one_header.jsp"> 
         <jsp:param name="username" value="<%= username%>" /> 
			...
			<div class="product_access" style="min-height: 280px; width:650px; overflow-y:scroll ">
			 
 <p class="strong">ProductAcl Details</p>
<form action="/KODE_DEV/ControllerServlet/SuperadminProductAccessServlet" name="pName1" method="post">
	<%  if(request.getAttribute("OwnerSuccess")!= null){%>
					<p class="autohide" style="color:green;"> <%= request.getAttribute("OwnerSuccess") %> </p>
         ...
         im=im+1;
			...
			%>
  <tr><td><input type="text" name="addName" id="addName" ></td><td><input type="text" name="addId" id="addId"></td><td><input type="submit" class="save" id="addrowsave" value=" &nbsp; " onClick="addRow(this.id)" /></td></tr>
		</tbody>
			</table>
			<table>
			<tbody>
			...
			<a style="color: #c2c2c2;" href="../JSP/SuperadminProductAcl.jsp">Back</a>
			</p>
