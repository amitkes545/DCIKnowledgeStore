...
function actionGetList(){
	...
	if(courseval=="")
		...
		document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_009&Course="+courseval+"&ExpRepFormat=None";
...
function actionRunExport(){
	...
	if(x>1)
		if(ExportVal=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_009&&Course="+courseval+"&ExpRepFormat="+ExportVal;
			document.ksStore.submit();
...
<body>
	...
	<div class="container">
		...
		<div class="postpon_mod">
			<div style="text-align: center;">
				<p class="strong">Students Exam Eligible</p>
	...
	<div class="table_section1">
		...
		<thead>
		 <tr class="row_head" >
			<th width="25%">Student ID<div class="header_stop" style="width:25%;">Student ID</div></th>
			<th width="25%">Student Name<div class="header_stop" style="width:25%;">Student Name</div></th>
			<th width="25%">Contact No<div class="header_stop" style="width:25%;">Contact No</div></th>
			<th width="25%">Email<div class="header_stop" style="width:25%;">Email</div></th>
		</tr>
		</thead>
