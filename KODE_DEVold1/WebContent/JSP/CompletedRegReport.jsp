...
var x = document.getElementById("tableColumn").rows.length;
	...
	if(x>1)
		if(ExportVal=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AD_002&ExpRepFormat="+ExportVal;
...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js"></script>
		...
		reportDomain1=dao.getCompletedRegistrationsByOrgID(organizationId);
...
<body>
	...
	<div class="container">
		...
		<p class="strong">Details of Completed Registrations</p>
