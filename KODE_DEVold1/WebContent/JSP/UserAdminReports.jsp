...
function validateReports(){
	...
	var id=document.getElementById("userid").value;
	 ...
	 if(id == ""){
		...
		document.userReports.action="/KODE_DEV/ControllerServlet/UsersAdminReportsServlet";
...
function getUserId(){
	...
	if(orgid == null || orgid == ""){
		...
		document.userReports.action="/KODE_DEV/ControllerServlet/UsersAdminReportsServlet?orgId="+orgid+"";
		document.userReports.submit();
	}
}
function onload(){
...
<body>
	...
	<%@include file="all_one_header.jsp" %>
		...
		<div class="search_details" style="height: 200px;">
			...
			<p class="strong_left">Admin Report</p>
        ...
        <td>
					...
					<tr>
						...
						<td style=""><input style="width: 100px; margin-left: -30px;"
							...
							href="../JSP/AdminReports.jsp">Back</a></td>
					</tr>
