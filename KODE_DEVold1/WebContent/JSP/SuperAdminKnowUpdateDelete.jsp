...
<%@ page import="com.kds.KODE_DEV.domain.SuperAdminReportKnowStoreDomain"%>
<%@ page import="com.kds.KODE_DEV.dao.SuperAdminSelectUserIDKSDao"%>
...
function update(){
    ...
    if(kssize==""){
 	   alert("Please enter knowledge store size ");
 	   return false;
	...
	document.UpdateDeleteForm.action = "/KODE_DEV/ControllerServlet/SuperAdminUpdateKStore";
	document.UpdateDeleteForm.submit();
	return true;
}
function delete1(){
	document.UpdateDeleteForm.action = "/KODE_DEV/ControllerServlet/SuperAdminDeletekStore";
	document.UpdateDeleteForm.submit();
}
</script>
</head>
	...
	<div class="container">
		...
		<div class="owner_setup" style="height: 350px; width: 500px;">
			...
			<p class="strong"> Know Store Management</p>
					...
					<%
	SuperAdminReportKnowStoreDomain rDomain = null; 
	
	       rDomain =  (SuperAdminReportKnowStoreDomain)request.getAttribute("msgvalue");
%>
			<form name="UpdateDeleteForm" method="post">
				<table>
					...
					<td>User ID</td>
						...
						<td><input readonly="readonly" name="userid" id="userid"
						   value="<%=rDomain.getUserId() %>" /></td>
								...
								<%
								SuperAdminSelectUserIDKSDao dobj3 = new SuperAdminSelectUserIDKSDao();
					...
					<tr>
						...
						<td>:</td>
						<td><input type="text" name="kssize" id="ksize"
