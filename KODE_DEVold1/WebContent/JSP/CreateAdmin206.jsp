...
<%
	...
	System.out.println("orgIIIIIIID "+orgid);
...
$(document).ready(function() {
    ...
    if (isValid == false){
	 ...
	 $(".fadehide").delay(6000).fadeOut("slow");  
});
...
<%@include file="../JSP/headers.jsp"%>
		...
		<div style="clear: both;"></div>
		<div class="faculty_mod" style="width:300px;margin-top: 80px;height:437px;overflow-x:hidden;overflow-y:scroll">
	...
	<form name='setupform' id='setupform' method="post" action="/KODE_DEV/ControllerServlet/CreateSetupAdmin">
         <div class="info">
			...
			<% 
				if (request.getAttribute("OwnerSuccess")!= null) { 
					String msg2=(String)request.getAttribute("OwnerSuccess");
					 String valid=msg2;
					%>
					<p class="fadehide" style="color: green; text-align: center;position:absolute;top:8px;right:-3px;"><%= valid %></p>
					<%
				}
				else if (request.getAttribute("UserExists")!= null) { 
					
					%>
					<p class="fadehide" style="color:red; text-align: center;position:absolute;top:8px;right:-3px;"><%= request.getAttribute("UserExists") %></p>					
					<%
				} 
				else  if (request.getAttribute("OwnerFailure")!= null) { 
					
					%>
					<p class="fadehide" style="color:red;text-align: center;position:absolute;top:8px;right:-3px;"><%= request.getAttribute("OwnerFailure") %></p>					
					<%
				} 
			...
			%>
				...
				<tr>
					<td><input type="text" name="adminname" class="box" placeholder="Admin name*" id="adminname"></td>
				</tr>
				<tr>
				...
				<tr><td>
								   ...
								   <input type="text" name="datepicker" id="datepicker" placeholder="Date of Birth*" class="box" readonly></td>
			...
			<p id="display"></p></td></tr>
				...
				<tr>
					<td><input type="text" placeholder="Postal Code" name="pcode" id="pcode" maxlength="10">
