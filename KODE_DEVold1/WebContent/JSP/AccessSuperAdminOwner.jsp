...
function validateAccessSearch(){
	...
	if(id == "" || id == null){
		...
		document.accessSuperAdmin.action="/KODE_DEV/ControllerServlet/AccessSuperAdminOwnerService";
...
function getUserId(){
	...
	if(orgid == null || orgid == ""){
		...
		document.accessSuperAdmin.action="/KODE_DEV/ControllerServlet/AccessSuperAdminOwnerService?orgId="+orgid+"";
		document.accessSuperAdmin.submit();
	}
}
function onload(){
