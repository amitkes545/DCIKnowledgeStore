...
.additional_result_row_tr td{border: 1px solid #000;padding: 4px; }
...
function onload(){
	...
	if(ViewID!=null && ViewID.length()>0) {
	 %> 
	 var selectBox = document.getElementById("ViewID");
...
<!-- second part starts here -->
   ...
   <div>  
		...
		<div class="search_div">
		<input class="box1" type="text" id="newgroupname" name="newgroupname" placeholder="Enter New Group Name">
		</div>
		<table align="center"><tr><td>
		<div class="headere" id="reee">
		<!-- heading starts here  -->
		
		<table><tr><th>Existing group members</th></tr></table>
		<table width="100%">
		<tr height="5px"></tr>
		<tr class="row_head">
		<td style="width:37px;">Sl #</td>
		<td>User ID</td><td>Name</td><td style="width:30px;">Action</td>
		</tr>
		</table>
		</div>
		<div class="no_search_result" id="reee">
		<table width="100%"  id="tblData">
		...
		//	System.out.println("in if");
		 ...
		 <td style="width:26px;"><%=count++%></td>
			<td>
			<input type="text" name="userid<%=userInfoDom.getUserId() %>" id="sessionId" value="<%=userInfoDom.getUserId() %>" class="userid" readonly="readonly">
			</td>
			<td>
			<input type="text" name="name<%=userInfoDom.getUserId()%>" value="<%=userInfoDom.getUserName() %>" class="my<%=i %>">
			</td>
		<td style="width:30px;">
			<a>
			<input class="icondelete" id="<%=i %>" type="image" name="icondel" onclick="iconclick()" value="<%=userInfoDom.getUserId()%>" src="../Image/cross1.png"  />
			<input class="editchkbox" id="my<%=i %>" type="checkbox" checked="checked" name="checkboxGroup" value="<%=userInfoDom.getUserId()%>"/>
			</a>
			</td>
			</tr> 
	 <%}  //while loop end
	...
	//	System.out.println("reststudentDetails2="+reststudentDetails2);
		if(reststudentDetails2!=null)
		 ...
		 <tr class="additional_result_row_tr row" id="row<%=i%>">
			...
			<td>
			<input type="text" name="name<%=userInfoDom.getUserId()%>" value="<%=userInfoDom.getUserName() %>" class="restmy<%=i %>">
			</td>
		<td>
			<a>
			<input class="icondelete" id="<%=i %>" type="image" name="icondel" onclick="iconclick()" value="<%=userInfoDom.getUserId()%>" src="../Image/cross1.png"  />
			<input class="editchkboxadditional" id="my<%=i %>" type="checkbox" name="checkboxGroup" value="<%=userInfoDom.getUserId()%>"/>
			</a>
			</td>
			</tr> 
<script type="text/javascript">
...
<table><tr><th>Select user from below list to add in group</th></tr></table>
	<table width="100%"  >
		 <tr height="5px"></tr>
			 <tr class="row_head">
			 <td>Sl #</td>
...
<td>
<a>
<input class="iconadd" id="restmyadd<%=i %>" type="image" name="iconadd" onclick="iconaddclick()" value="<%=userInfoDom.getUserId()%>" src="../Image/plus.png"  />
<!-- <input class="editchkbox" id="my<%=i %>" type="checkbox" checked="checked" name="checkboxGroup" value="<%=userInfoDom.getUserId()%>"/> -->
</a>
</td>
</tr> 
...
//------------ current group members list end
		if(reststudentDetails2!=null)
		 ...
		 <tr class="result_row_tr row" id="restrowadd<%=i%>">
		 <td>
		 <input type="text" name="sl_no<%=userInfoDom.getUserId() %>" value="<%=count1++%>" class="restmy<%=i%>"></td>
			<td>
			<input type="text" name="userid<%=userInfoDom.getUserId() %>" id="sessionId" value="<%=userInfoDom.getUserId() %>" class="userid" readonly="readonly">
			</td>
			<td>
	...
	<td>
			<a>
			<input class="iconadd" id="restmyadd<%=i %>" type="image" name="iconadd" onclick="iconaddclick()" value="<%=userInfoDom.getUserId()%>" src="../Image/plus.png"  />
			<!-- <input class="editchkbox" id="restmy<%=i %>" type="checkbox" name="checkboxGroup" value="<%=userInfoDom.getUserId()%>"/>-->
			</a>
			</td>
			</tr> 
	 <%}  //while loop end
...
<tr><td colspan=2>  
	...
	<a><input class="btnsaction" type="button" name="deleteButton" onclick="clickDeleteGroup()" id="deleteButton" value="Delete" /></a>
	<!-- <a><input class="btnsaction" type="button" name="removeButton" onclick="clickRemove()" id="removeButton" value="Add \ Remove" /></a> -->
	<a><input class="btnsdelete" type="button" name="deleteButton" onclick="clickSaveGroup()" id="deleteButton" value="Save" /></a>
	<a><input class="btnscancel" type="button" name="cancelButton" onclick="clickCancel()" id="cancelButton" value="Reset" /></a>
</td></tr></table>
</div>
</div>
</div>
...
<p class="autohide" style="color:green; font-size:17px; font-weight: bold; top: 40%; left: 42%; position: absolute;"><%=responseMsgValue%></p>					
					<%}%>
