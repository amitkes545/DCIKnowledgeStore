...
function validateAccessSearch(){
	...
	if(id == "" || id == null){
		...
		document.accessSuperAdmin.action="/KODE_DEV/ControllerServlet/AccessStudentServlet";
...
<%-- <div class="container">
 ...
 <p class="strong">Access Student</p>
<form  method="post" name="accessSuperAdmin">
     ...
     <td>:</td> -->
        <td>
							 <%SearchAdminDao searchAdminDao= new SearchAdminDao();
					           ArrayList<AdminDomain>ad1=new ArrayList<AdminDomain>();
							    ad1=searchAdminDao.selectStudentId(orgid,userid);
							    Iterator<AdminDomain> it1= ad1.iterator();%>
							    
							    <select name="studentId" id="studentId" class="box_lng" style="margin-right:20px">
				 ...
				 <tr height="20px;"></tr>
						...
						<input class="add_btn1" type="button" value="search" onclick="validateAccessSearch()"> </td>
				 </tr>
