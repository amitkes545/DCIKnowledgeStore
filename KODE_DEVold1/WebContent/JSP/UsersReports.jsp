...
function validateReports(){
	...
	if(orgid == "" || orgid == ""){
		...
		document.userReports.action="/KODE_DEV/ControllerServlet/UsersReportsServlet";
...
function getUserId(){
	...
	if(orgid == null || orgid == ""){
		...
		document.userReports.action="/KODE_DEV/ControllerServlet/UsersReportsServlet?orgId="+orgid+"";
		document.userReports.submit();
	}
}
function onload(){
...
<body>
	...
	<%@include file="all_one_header.jsp" %>
		...
		<div class="search_details" style="height: 228px;">
        ...
        <td>
					...
					<tr>
						...
						<td style=""><input style="width: 100px; margin-left: -30px;"
							...
							href="../JSP/Reports.jsp">Back</a></td>
					</tr>
