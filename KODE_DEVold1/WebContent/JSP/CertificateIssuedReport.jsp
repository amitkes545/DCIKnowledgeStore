...
function actionGetList(){
	...
	if(courseval=="")
		...
		document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AD_014&Course="+courseval+"&ExpRepFormat=None";
...
var x = document.getElementById("tableColumn").rows.length;
	...
	if(x>1)
		if(ExportVal=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AD_014&&Course="+courseval+"&ExpRepFormat="+ExportVal;
			document.ksStore.submit();
	...
	<div class="container">
		...
		<div class="postpon_mod">
			<div style="text-align: center;">
				<p class="strong">Certificates Issued Students</p>
