...
<html>
<head>
<script type="text/javascript" src="../JS/OpenCourseJs.js"></script>
...
<form name="OpenCourses" method="post">
<ul class="subject-ul">
...
//ArrayList<DepartmentsDomain> arl=(ArrayList<DepartmentsDomain>)request.getAttribute("openCoursesList");
	...
	while(it.hasNext())
    {
     ...
     %>
     				<li class="nn-part"><a href="#" ><img class="dbimg" src="<%=dd.getImagePath().toString()%>"/><br/><span><input class="sub_btn" type="submit" name="OpenCourseName" value="<%=dd.getCourseName()%>" onclick="openCourse()"></input></span></a></li>
