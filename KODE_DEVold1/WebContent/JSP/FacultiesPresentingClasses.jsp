...
function actionGetList(){
	...
	document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_003&startDate="+startDate+"&endDate="+endDate+"&sessionId="+sessionId+"&ExpRepFormat=None";
...
var x = document.getElementById("tableColumn").rows.length;
	...
	if(x>1)
		if(exportval=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_003&startDate="+startDate+"&endDate="+endDate+"&sessionId="+sessionId+"&ExpRepFormat="+exportval;
			document.ksStore.submit();
...
<body>
	...
	<div class="container">
		...
		<p class="strong">Details Of Faculties Presenting Classes</p>
		 <form name="ksStore" method="post">
		 <div class="combo_box_column row">
		 
		 <input class="box1" type="text" id="SDate"value="" placeholder="Start Date*" >
		 <input class="box1" type="text" id="EDate" value=""placeholder="End Date*" >
		...
		<thead>
		 <tr class="row_head" >
			...
			<th width="20%">Faculty ID<div class="header_stop" style="width:20%;">Faculty ID</div></th>
	<th width="20%">aculty Name<div class="header_stop" style="width:20%;">Faculty Name</div></th>
		</tr>
		</thead>
		...
		<%=stuinfo.get("Date_Time").toString().trim()%>
		</td>
		<td width="20%" style="text-align:center;">
		...
		<td width="20%" style="text-align:center;">
		<%=stuinfo.get("FacultyId").toString().trim()%>
		</td>
		<td width="20%">
		<%=stuinfo.get("FacultyName").toString().trim()%>
		</td>
		</tr>
		 <%}
