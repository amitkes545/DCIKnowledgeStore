...
function actionGetList(){
	...
	if(courseval=="")
		...
		document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AN_001&Course="+courseval+"&ExpRepFormat=None";
...
var x = document.getElementById("tableColumn").rows.length;
	...
	if(x>1)
		if(ExportVal=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AN_001&&Course="+courseval+"&ExpRepFormat="+ExportVal;
			document.ksStore.submit();
	...
	<div class="container">
		...
		<div class="postpon_mod">
			<div style="text-align: center;">
				<p class="strong">No. Of Enrollments</p>
		...
		<thead>
		 <tr class="row_head"  >
			<th width="33.3%">Course Name <div class="header_stop" style="width:33.3%;">Course Name</div></th>
			<th width="33.3%">Country<div class="header_stop" style="width:33.3%;">Country</div></th>
			<th width="33.3%">No. Of Students<div class="header_stop" style="width:33.3%;">No. Of Students</div></th>
		</tr>
		</thead>
		...
		<td width="33.3%" style="text-a;ign:center;">
		<%=stuinfo.get("no_of_enrolments").toString().trim()%>
		</td>
