...
<div style="clear: both;"></div>
 ...
 <p class="strong_left">Access Details</p>
...
%>
	  <p style="color: green;margin-left: 210px"> User Id:<%=session.getAttribute("AccessUserId").toString() %></p>
	<table border="1">
	...
	<p style="padding-top: 10px">	<a class="back" style="color: #c2c2c2; margin-left: 150px; margin-top: 15px; font-weight: bold;" href="../JSP/AccessDetails.jsp">Back</a></p>
