...
function validateReports(){
	...
	var id=document.getElementById("userid").value;
	 ...
	 if(id == ""){
		...
		document.userReports.action="/KODE_DEV/ControllerServlet/UsersFacilitatorReportsServlet";
...
function getUserId(){
	...
	if(orgid == null || orgid == ""){
		...
		document.userReports.action="/KODE_DEV/ControllerServlet/UsersFacilitatorReportsServlet?orgId="+orgid+"";
		document.userReports.submit();
	}
}
function onload(){
...
<body>
	...
	<%@ include file="../JSP/all_one_header.jsp" %>
		...
		<div class="search_details" style="height: 200px;">
			...
			<p class="strong_left">Facilitator Report</p>
