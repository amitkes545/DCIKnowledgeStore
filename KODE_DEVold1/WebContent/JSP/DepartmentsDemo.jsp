...
%>
     				<li class="nn-part"><a href="#" ><img class="dbimg" src="<%=dd.getImageLocation().toString()%>"/><br/><span><input class="sub_btn" type="submit" name="DepartmentsName" value="<%=dd.getDepartmentsNmae()%>" onclick="Sem()"></input></span></a></li>
