...
function actionGetList(){
	...
	document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_008&ResultStatus="+studentSemesterStatus+"&ExpRepFormat=None";
...
function actionRunExport(){
	...
	document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_008&ResultStatus="+studentSemesterStatus+"&ExpRepFormat="+exportval;
	document.ksStore.submit();
}
</script>
...
<body>
	...
	<div class="container">
		...
		<p class="strong">Details Of Students Assessments Results</p>
		 <form name="ksStore" method="post">
		 <div class="combo_box_column row"> 
		 <select name="ResultStatus" id="ResultStatus" value=""class="opt"  >
	...
	<div class="table_section1">
		...
		<thead>
		 <tr class="row_head"  >
			<th width="20%">Student<div class="header_stop">Student</div></th>
			<th width="20%">Assessment<div class="header_stop">Assessment</div></th>
			<th width="20%">Assessment Description<div class="header_stop">Assessment Description</div></th>
			<th width="20%">Marks<div class="header_stop">Marks</div></th>
			<th width="20%">Result<div class="header_stop">Result</div></th>
		</tr>
		</thead>
		...
		<td width="20%">
		<%=stuinfo.get("assessment_id").toString().trim() %>
		</td>
		<td width="20%">
		<%=stuinfo.get("assessment_description").toString().trim()%>
		</td>
		<td width="20%">
	...
	<select name="exportval" id="exportval" class="opt" >
