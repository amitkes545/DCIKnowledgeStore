<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.kds.KODE_DEV.domain.*,com.kds.KODE_DEV.dao.*" %>
     <%@page import="java.util.*" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<script type="text/javascript" src="../JS/InstitutionListDetails.js"></script>
...
<form name="InstitutionName" method="post">
<ul class="subject-ul">
...
ArrayList<DisplayCoursesDomain> arl=ild.selectInstitutions();
	...
	while(it.hasNext())
     ...
     %>
     				<li class="nn-part"><a href="#" ><img class="dbimg" src="<%=dd.getImagePath().toString()%>"/><br/><span><input class="sub_btn" type="submit" name="InstitutionName" value="<%=dd.getCourseName()%>" onclick="InstitutionDetails()"></input></span></a></li>
