...
/* 		 $(":checkbox").click(function(){
	...
	//	alert(id);
        ...
        if (isValid == false){
	        	...
	        	document.cerify.action="/KODE_DEV/ControllerServlet/deleteAssignmentForFaculty";
	     		document.cerify.submit();	
	        }
	    else {alert("Please select assignment to delete!");}
	         //alert(cnt);  
	    });
	});     
</script>
...
$(document).ready(function() {
	...
	//});
	  ...
	  $('#subjects').change(function () {
		 ...
		 //    $.get('${pageContext.request.contextPath}/getAssignmentsForSubjectCourse', {selectedValue : selectedValue},
		    		  function(jsonResponse) {
		    			//alert(jsonResponse);
		    		//	alert("inside");
		    			console.log("json response :",jsonResponse);
...
//	alert("assessment id:"+courses);
//	alert("assessment id:"+subjects);
	document.cerify.action="/KODE_DEV/ControllerServlet/DeleteAssignmentsServlet?assessid="+assessid+"?courses="+courses+"?subjects="+subjects+"";
	document.cerify.submit();
}
