...
<%@include file="all_one_header.jsp" %>
		<%-- <jsp:include page="../JSP/all_one_header.jsp"> 
         <jsp:param name="username" value="<%= username%>" /> 
			...
			<div class="customer_create" style="height: 200px; padding-right: 0px">
			 
 <p class="strong">Reports</p>

<table>
  <tr height="30px"><td><a href="../JSP/UserSuperAdminReports.jsp">User Details</a>
  <tr height="30px"><td><a href="../JSP/SuperadminAccessDetails.jsp">Access Details</a>
