...
<!-- <script type="text/javascript">
	function validation1() {
		if (valid()) {
			document.KnowStoreReport.action = "/KODE_DEV/ControllerServlet/FacilitatorKAssetsReportServlet";
...
<body>
	<div class="container">
		...
		<div class="owner_setup_faculty" >
			...
			<p class="strong" style="font-size: 15px;">Knowledge Assets View</p>
			<form name="KnowStoreReport" method="post">
				<table align="center">
					<tr>
						...
						<td><select name="ksid" id="ksid" class="box_lng">
								...
								FacilitatorSelectKnowStoreIdDao dobj2 = new FacilitatorSelectKnowStoreIdDao();
									ArrayList<String> al = dobj2.fetchFKsid(session.getAttribute("userid").toString());
									...
									while (itr.hasNext()) {
										...
										String ksIdAndDepartment = (ksId+" ("+department+")");
								%>
								<option value="<%=ksId%>"><%=ksIdAndDepartment%></option>
								 <%
									}
								%> 
						</select></td>
					...
					<tr>
						<td>
						<!-- <input class="add_btn1" style="width: 262px!important" type="button" value="View" onclick="validation1()"> -->
