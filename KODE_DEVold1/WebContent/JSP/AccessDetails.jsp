...
function validateAccessReports() {
	...
	if(orgid == "" ||orgid == null){
		...
		//alert("else");
		document.accessReports.action="/KODE_DEV/ControllerServlet/AccessReportsServlet";
...
<div class="container">
 ...
 <%-- <jsp:include page="../JSP/all_one_header.jsp"> 
		...
		<div class="search_details" style="height: 220px; padding-right: 0px; width: 500px;">
