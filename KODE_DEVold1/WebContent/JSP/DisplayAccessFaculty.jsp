...
//HttpSession mess = request.getSession();
	...
	String selectedFacultyId =(String)session.getAttribute("facultyId");
	//System.out.println("selectedFacultyId"+selectedFacultyId);
...
<body>
	...
	<div class="container">
		...
		<div class="product_access" style="height: 280px;">
			...
			%>
			<form
				action="/KODE_DEV/ControllerServlet/DisplayAccessFacultyServlet"
				method="post">
				<table border="2">
     ...
     %>
				...
				<p style="text-align: center; margin-left: -125px;">
					...
					<a style="color: #c2c2c2;" href="../JSP/AccessFaculty.jsp">Back</a>
				</p>		
						 <input type="hidden"
						name="selectedUserId" id="selectedUserId" value="<%=selectedFacultyId%>">
			</form>
</div>
