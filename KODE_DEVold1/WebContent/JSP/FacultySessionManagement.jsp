...
<div class="container from-top">
					...
					<ul class="sem_list1_ul">
						...
						FacultySessionDao dc=new FacultySessionDao();
						...
						arl=dc.selectCourses(ri);
							...
							while(it.hasNext())
						    {
						     ...
						     %>
						       <li class="nn-part">
						       <a href="/KODE_DEV/ControllerServlet/FacultySessionDetailsService?sessionId=<%=dd.getCourseImageLocation() %>">
						       <img class="dbimg" src="../imagelist/bend.png"/><br/>
						       <span><%=dd.getCourseName()%></span>
						        <br>
						        </a>
						        </li>
						  <%  } %>
