...
<%@include file="headers.jsp"%>
		...
		<% 
				if (request.getAttribute("OwnerSuccessMAil")!= null) { 
					...
					%>
					<p class="failure"><%= request.getAttribute("OwnerSuccess") %></p>					
					<%
				} 
		...
		<p class="strong" >Create User</p>
         ...
         <div class="info">
			...
			<tr><td><input type="text" class="box" placeholder="User Name*" name="orgname" id="orgname" maxlength="25"></td></tr>
			<tr>
			<td class="sel">
			<select name="orgid" id="orgid" class="opt" required placeholder="Choose Customer Details" >
				...
				<tr style="display:none;"><!-- <td>Name<span class="astr">*</span></td><td>:</td> -->
            <td><input type="text" placeholder="Date of Birth*" name="datepicker" value="01/01/2017" id="datepicker" class="box" readonly style=display:none></td>
              </tr> 
			...
			<tr>
				...
				<tr>
					<td><textarea rows="5" maxlength="500" class="required box1" placeholder="Address*" cols="25" name="address" id="address"></textarea></td>
				</tr>
                  
				<tr>
					<!-- <td>Postal Code<span class="astr">*</span></td><td>:</td> -->
					<td><input type="text" name="pcode"  placeholder="Postal Code" id="pcode" maxlength="6" class="box2"></td>
				</tr>
				
	
				<tr>
					<td><input class="btn1" id="btnSubmit" type="button" value="Create" onClick="return SubmitIfValid()" style="width:265px;"> 
