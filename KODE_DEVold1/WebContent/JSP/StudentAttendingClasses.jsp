...
function actionGetList(){
	...
	document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_001&startDate="+startDate+"&endDate="+endDate+"&sessionId="+sessionId+"&ExpRepFormat=None";
...
var x = document.getElementById("tableColumn").rows.length;
	...
	if(x>1)
		if(exportval=="PDF")
		{
			document.ksStore.action="/KODE_DEV/ControllerServlet/MISReportListService?RepID=MIS_AC_001&startDate="+startDate+"&endDate="+endDate+"&sessionId="+sessionId+"&ExpRepFormat="+exportval;
			document.ksStore.submit();
...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js"> </script>
		...
		reportDomain1 = (ArrayList<HashMap<String,String>>)request.getAttribute("StAttendenceDetailsTabledata");
...
<body>
	...
	<div class="container">
		...
		<p class="strong">Details Of Student Attending Classes</p>
