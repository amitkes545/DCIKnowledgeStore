 ...
 */
var global_file_name=sessionStorage.getItem(
		"file");
//alert ('global_file_name '+ global_file_name);
...
//  file = 'file' in params ? params.file : appConfig.defaultUrl;
  file=global_file_name;
  //alert ('appConfig.defaultUrl '+ appConfig.defaultUrl);
 // alert ('file '+ file);
...
//	alert('in web viewer file input change');
...
function webViewerOpenFile() {
	//alert('in web viewwer open file');
  var openFileInputName = PDFViewerApplication.appConfig.openFileInputName;
 // alert('openFileInputName '+ openFileInputName);
