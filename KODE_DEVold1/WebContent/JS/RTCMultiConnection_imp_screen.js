...
alert("in share1");
    ...
    window.RTCMultiConnection = function(channel1) {
    	alert("in share12");
...
alert("Before join session");
        ...
        function captureUserMedia(callback, _session, dontCheckChromExtension) {
            ...
            alert("session="+session.screen);
            // if screen is prompted
            
            if (session.screen) {
            	//alert("if screen prompted");
...
alert("after function");
    ...
    function setDefaults(connection) {
        ...
        connection.bandwidth = {
            screen: 50 // 300kbps (dirty workaround)to decrease the banawidth
        };
...
//        	};
        ...
        connection.onstream = function(e) {
          ...
          /*  alert("in onstream insertBefore");
            var extraInformation = e.extra;
