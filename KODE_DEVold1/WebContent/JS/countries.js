...
s_a[2]="Berat|Bulqize|Delvine|Devoll (Bilisht)|Diber (Peshkopi)|Durres|Elbasan|Fier|Gjirokaster|Gramsh|Has (Krume)|Kavaje|Kolonje (Erseke)|Korce|Kruje|Kucove|Kukes|Kurbin|Lezhe|Librazhd|Lushnje|Malesi e Madhe (Koplik)|Mallakaster (Ballsh)|Mat (Burrel)|Mirdite (Rreshen)|Peqin|Permet|Pogradec|Puke|Sarande|ShKODE_DEVr|Skrapar (Corovode)|Tepelene|Tirane (Tirana)|Tirane (Tirana)|Tropoje (Bajram Curri)|Vlore";
...
function populateStates( countryElementId, stateElementId ){
	console.log('enters on load of State');
...
function populateCountries(countryElementId, stateElementId){
	...
	console.log('enters on load of country');
	console.log('enters on load of country countryElementId ',countryElementId);
	console.log('enters on load of country stateElementId ',stateElementId);
