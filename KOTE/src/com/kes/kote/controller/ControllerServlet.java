package com.kes.kote.controller;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(cs == null){
				...
				String className = "com.kes.kote.services."+name;//it call to the LoginService class which is available in com.kds.logindemo.service
