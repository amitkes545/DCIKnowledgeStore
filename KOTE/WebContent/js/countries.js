...
function populateCountries(countryElementId, stateElementId,country,state){
	...
	for (var i=0; i<country_arr.length; i++) {
		...
		var string1=country_arr[i];
	    var string2=country;
	    var wospace1=string1.replace(/\s/g,'');
	    var wospace2=string2.replace(/\s/g,'');
	    var lower1=wospace1.toLowerCase();
	    var lower2=wospace2.toLowerCase();
